            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-200  border-black">
             ...
             <tbody>
                ...
                <tr class="">
                   ...
                   <td scope="row" class="border text-center px-6 py-4 whitespace-nowrap text-white">{{$row->judul_materi}}</td>
                   ...
                   <td class=" px-2 py-4 text-center border">
                       <div class="flex items-center justify-center">
                           <a href="{{route('materi.edit', $row->id)}}" class="font-medium text-white-600 dark:text-white-500 hover:text-white hover:underline"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
