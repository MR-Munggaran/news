<ul id="slider">
        <li class="relative">
            <a href="{{route('detail', $slidepertama->artikel->slug)}}"><img src="{{asset('uploads/' . $slidepertama->gambar)}}" alt="Hero Image" class="w-full h-auto"/></a>
        ...
        <li class="relative hidden">
            <a href="{{route('detail', $item->artikel->slug)}}"><img src="{{asset('uploads/' . $item->gambar)}}" alt="Hero Image" class="w-full h-auto"/></a>
            <div class="absolute top-0 left-1.5 p-2 md:top-2 md:left-2">
